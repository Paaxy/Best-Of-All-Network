document.addEventListener('DOMContentLoaded', () => {
    ...
    const currentPage = location.pathname.split('/').pop() || 'entertainment.html';
    navLinks.forEach(a => {
        const href = a.getAttribute('href');
        if (href === currentPage || (href === '' && currentPage === 'entertainment.html')) {
    ...
    if (logo) logo.addEventListener('click', () => { location.href = 'entertainment.html'; });
